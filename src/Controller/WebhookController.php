...
final class WebhookController extends AbstractController
{
    ...
    public function dispatchContactAutomationEventAction(Request $request): Response
    {
        /** @var array{"id":string, "email":string,"first_name":string,"last_name":string,"phone":string,"ip4":string,"tags":string,"customer_acct_name":string,"orgname":string} $contact */
        $contact = $request->request->all('contact');
