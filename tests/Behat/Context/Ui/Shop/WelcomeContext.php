...
namespace Tests\Webgriffe\SyliusActiveCampaignPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Webgriffe\SyliusActiveCampaignPlugin\Behat\Page\Shop\WelcomePageInterface;
